...
import { FaPhoneVolume, FaFacebookF, FaTwitter, FaLinkedin, FaInstagram } from "react-icons/fa";

const Footer = () => {
  return (
    <div className="w-full bg-black flex flex-col lg:flex-row items-start justify-between lg:px-[80px] px-[20px] lg:py-[50px] py-[30px] gap-[60px]">
